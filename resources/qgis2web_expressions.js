...
function exp_FloodLines_2rule0_eval_expression(context) {
    // DESCR = '1:20 year flood line'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('DESCR')  == '1:20 year flood line');
    } else {
        return (feature.get('DESCR')  == '1:20 year flood line');
    }
}
...
function exp_FloodLines_2rule1_eval_expression(context) {
    // DESCR = '1:100 year flood line'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('DESCR')  == '1:100 year flood line');
    } else {
        return (feature.get('DESCR')  == '1:100 year flood line');
    }
}